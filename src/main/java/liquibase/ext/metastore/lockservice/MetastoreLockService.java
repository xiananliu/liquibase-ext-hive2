...
public class MetastoreLockService extends StandardLockService {
    ...
    private static final Logger LOG = Scope.getCurrentScope().getLog(MetastoreLockService.class);
    private ObjectQuotingStrategy quotingStrategy;
    private Boolean lockDb = true;
...
//                }
    ...
    public boolean acquireLock() throws LockException {
        ...
        try {
            ...
            Boolean locked = (Boolean) Scope.getCurrentScope().getSingleton(ExecutorService.class).getExecutor(database).queryForObject(new SelectFromDatabaseChangeLogLockStatement("LOCKED"), Boolean.class);
